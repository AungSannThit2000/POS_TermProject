...
import { loadTransactions } from "../lib/storage";import {
  sumAllTime,
  filterByPeriod,
  salesByCategory,
  topNProducts,
...
import PeriodSelector from "../components/PeriodSelector";import StatCard from "../components/StatCard";import SalesLineChart from "../components/Charts/SalesLineChart";import CategoryPieChart from "../components/Charts/CategoryPieChart";import TopItemsBarChart from "../components/Charts/TopItemsBarChart";
      ...
      <Card>
        <CardContent>
          <Stack direction="row" gap={1} alignItems="center" flexWrap="wrap" sx={{ mb: 2 }}>
            ...
            <ToggleButtonGroupexclusivevalue={trendMode}onChange={(_, v) => v && setTrendMode(v)}
              size="small"
            >
          ...
          <SalesLineCharttitle={trendMode === "monthly" ? "Monthly sales trend" : "Daily sales trend"}
            data={trendData}          />
        </CardContent>
      </Card>
